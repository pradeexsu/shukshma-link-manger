        ...
        return (
            <li key={item.key} className="list-group-item d-flex justify-content-between align-items-start">
                <div className="ms-2 me-auto">
                    ...
                    <span className="font-weight-light font-italic">{(new Date(item.updatedAt)).toGMTString()}</span>
                </div>
                
                <a className="font-italic font-weight-light" href={`http://${url}`} target="_blank">{url}</a>
                &nbsp;&nbsp;&nbsp;
